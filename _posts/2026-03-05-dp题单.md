...
| 746  | [使用最小花费爬楼梯](https://leetcode.cn/problems/min-cost-climbing-stairs/)                        | ✅    | 字节       |    |
| 1137 | [第 N 个泰波那契数](https://leetcode.cn/problems/n-th-tribonacci-number/)                         | ✅    | 字节、腾讯    |    |
| 377  | [组合总和 Ⅳ](https://leetcode.cn/problems/combination-sum-iv/description/)                     | ✅    | 字节、华为、京东 |    |
| 2466 | [统计构造好字符串的方案数](https://leetcode.cn/problems/count-ways-to-build-good-strings/description/) | ✅    | 字节       |    |
| 2266 | [统计打字方案数](https://leetcode.cn/problems/count-number-of-texts/description/)                 | ✅    | 字节       |    |
| 2533 | [好二进制字符串的数量](https://leetcode.cn/problems/number-of-good-binary-strings/description/)      | ✅    |          |    |

#### 2. 打家劫舍

| 题号   | 题目                                                                                           | 是否完成 | 国内公司                           | 备注 |
|------|----------------------------------------------------------------------------------------------|------|--------------------------------|----|
| 198  | [打家劫舍](https://leetcode.cn/problems/house-robber/)                                           | ✅    | 字节、腾讯、华为<br>百度、同花顺、网易<br>京东、高德 | ⭐  |
| 213  | [打家劫舍 II](https://leetcode.cn/problems/house-robber-ii/)                                     | ✅    | 字节、B站、腾讯<br>华为、微信              |    |
| 2320 | [统计放置房子的方式数](https://leetcode.cn/problems/count-number-of-ways-to-place-houses/description/) | ✅    | 字节                             |    |
